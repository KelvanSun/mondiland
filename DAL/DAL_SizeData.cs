...
{
    public class DAL_SizeData:BaseDal<Table_SizeData_Entity>,ITable_SizeData
    {
        public static DAL_SizeData Instance
		{
			get
			{
				return new DAL_SizeData();
			}
		}
        public DAL_SizeData()
            : base("SizeData", "id", "size_name", OrderType.ASC)
		{
        ...
        protected override Table_SizeData_Entity DataReaderToEntity(IDataReader dataReader)
        {
            Table_SizeData_Entity entity = new Table_SizeData_Entity();
        ...
        protected override Hashtable GetHashByEntity(Table_SizeData_Entity obj)
        {
            Table_SizeData_Entity info = obj as Table_SizeData_Entity;
