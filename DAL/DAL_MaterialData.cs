...
{
    public class DAL_MaterialData:BaseDal<Table_MaterialData_Entity>,ITable_MaterialData
    {
        public static DAL_MaterialData Instance
		{
			get
			{
				return new DAL_MaterialData();
			}
		}
        public DAL_MaterialData()
            : base("MaterialData", "id", "order_index", OrderType.ASC)
		{ }
        ...
        protected override Table_MaterialData_Entity DataReaderToEntity(IDataReader dataReader)
        {
        ...
        protected override Hashtable GetHashByEntity(Table_MaterialData_Entity obj)
        {
            Table_MaterialData_Entity info = obj as Table_MaterialData_Entity;
